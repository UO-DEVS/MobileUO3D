...
namespace ClassicUO
{
    sealed class UltimaOnline
    {
        ...
        public unsafe void Load(GameController game)
        {
            ...
            game.GraphicsDevice.Textures[1].UnityTexture.filterMode = UnityEngine.FilterMode.Point;
            game.GraphicsDevice.Textures[2].UnityTexture.filterMode = UnityEngine.FilterMode.Point;
            //game.GraphicsDevice.Textures[3].UnityTexture.filterMode = UnityEngine.FilterMode.Point;
