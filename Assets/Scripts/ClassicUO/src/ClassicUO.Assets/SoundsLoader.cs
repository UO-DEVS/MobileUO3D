...
namespace ClassicUO.Assets
{
    public sealed class SoundsLoader : UOFileLoader
    {
        ...
        public override void Load()
        {
            ...
            if (File.Exists(path))
            {
                // MobileUO: don't worry about subdirectories, we'll recursively search them all
                string musicDir = FileManager.GetUOFilePath(@"Music");
                ...
                using (var reader = new StreamReader(path))
                {
                    ...
                    while ((line = reader.ReadLine()) != null)
                    {
                        ...
                        if (TryParseConfigLine(line, musicFileList, out (int index, string name, bool loop) data))
                        {
        ...
        // MobileUO: added musicFileList parameter
        private bool TryParseConfigLine(string line, string[] musicFileList, out (int index, string name, bool loop) data)
        {
            data = default;
        ...
        private string GetTrueFileName(string name, string[] musicFileList)
        {
            ...
            // MobileUO: TODO: get this version to work
