...
namespace ClassicUO.Game.Scenes
{
    internal partial class GameScene
    {
        ...
        // MobileUO: TODO: get newer version to work
        ...
        private void GetViewPort()
        {
            ...
            if (ProfileManager.CurrentProfile != null /*&& ProfileManager.Current.EnableScaleZoom*/)
            {
            ...
            if (maxBlockX >= Client.Game.UO.FileManager.Maps.MapsDefaultSize[_world.Map.Index, 0])
                maxBlockX = Client.Game.UO.FileManager.Maps.MapsDefaultSize[_world.Map.Index, 0] - 1;
